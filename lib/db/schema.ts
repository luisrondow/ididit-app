...
export const CREATE_INDEXES = `
  ...
  CREATE INDEX IF NOT EXISTS idx_log_entries_habit_id ON log_entries(habit_id);
  CREATE INDEX IF NOT EXISTS idx_log_entries_completed_at ON log_entries(completed_at);
  CREATE INDEX IF NOT EXISTS idx_log_entries_habit_completed ON log_entries(habit_id, completed_at);
`;
